...
function Chatbot() {
  ...
  return (
    <>
      <Header />
      <div className='chatbot-full-avatar-div-button'>

      
      <div className='chatbot-full-avatar-div'>
        <img className='chatbot-full-avatar' src={require("../../assets/leora_chatavatar.png")} alt="ChatBot" />
      </div>
      <Button
        type="submit"
        fullWidth
